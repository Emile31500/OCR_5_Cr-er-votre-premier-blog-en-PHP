 ...
 formulaire_ajout_article.addEventListener("submit", function(event){
    ...
    xml.onreadystatechange = function () {
        ...
        if (res.status == true) {
            ...
            alert_zone.innerHTML = "L'article a bien été mis à jour";
            return true;
            ...
            alert_zone.innerHTML = "Erreur : l'article n'a pas put être modifié";
            return false;
    ...
    xml.open("POST", "http://127.0.0.1/Projet%20OC5/article/edition", true);
    xml.send(data);
